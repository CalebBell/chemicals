...
def Hfus(CASRN: str, get_methods: bool = ..., method: None = ...) -> Optional[Union[List[str], float]]: ...
...
def Tb(CASRN: str, get_methods: bool = ..., method: Optional[str] = ...) -> Optional[Union[List[str], float]]: ...


def Tm(CASRN: str, get_methods: bool = ..., method: Optional[str] = ...) -> Optional[Union[List[str], float]]: ...
