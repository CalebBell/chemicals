...
is_x86_or_x86_64_or_mac_arm = platform.machine().lower() in ("i386", "i686", "x86", "x86_64", "amd64") or (sys.platform == "darwin" and platform.machine() == "arm64")
...
def pytest_ignore_collect( collection_path, config):
    ...
    skip_paths = ("cx_freeze", "py2exe", "manual_runner", "make_test_stubs", "plot", "prerelease", "benchmarks", "conf.py", "dev", "setup", "_custom_build")
    ...
    unsupported_for_numba = (
        ...
        is_graal or
        is_free_threaded or
        not is_x86_or_x86_64_or_mac_arm
    )
...
def pytest_configure(config):
    ...
    # Set low memory environment variable
